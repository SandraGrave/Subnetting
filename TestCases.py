...
# ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    def test_wenn_umwandlung_int_32_zu_subnetzmaske_gueltige_eingabe_gebe_subnetzmaske_zurueck(self):
    ...
    def test_wenn_umwandlung_int_32_zu_subnetzmaske_eingabe_minimum_gebe_subnetzmaske_zurueck(self):
        subnetzmaske = 0b00000000000000000000000000000000           # = 00000000 00000000 00000000 00000000
        self.assertEqual(main.umwandlung_int_32_zu_subnetzmaske(subnetzmaske), "0.0.0.0")

    def test_wenn_umwandlung_int_32_zu_subnetzmaske_eingabe_maximum_gebe_subnetzmaske_zurueck(self):
...
# ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    def test_umwandlung_subnetzmaske_zu_int_32(self): # 1x 0.0.0.0, 255.255.255.255
    ...
    def test_umwandlung_subnetzmaske_zu_int_32(self):
        netz_ip =['255', '255', '255', '255']
        self.assertEqual(main.umwandlung_subnetzmaske_zu_int_32(netz_ip), 0b11111111111111111111111111111111)           # = 11111111 11111111 11111111 11111111

    def test_umwandlung_subnetzmaske_zu_int_32(self):
        netz_ip =['0', '0', '0', '0']
        self.assertEqual(main.umwandlung_subnetzmaske_zu_int_32(netz_ip), 0b00000000000000000000000000000000)           # = 00000000 00000000 00000000 00000000

# ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    def test_wenn_erstelle_bitmaske_netzwerkpart_eingabe_ist_gueltig_gebe_subnetzmaske_zurueck(self):  # Anzahl der Bits für Netzwerkpart, 1en werden gesetzt
        freie_bits_hostpart = 8
        self.assertEqual(main.erstelle_bitmaske_netzwerkpart(freie_bits_hostpart), 0b11111111111111111111111100000000)  # = 11111111 11111111 11111111 00000000

    def test_wenn_erstelle_bitmaske_netzwerkpart_keine_freien_bits_fuer_hostpart_gebe_subnetzmaske_zurueck(self):
        freie_bits_hostpart = 0
        self.assertEqual(main.erstelle_bitmaske_netzwerkpart(freie_bits_hostpart), 0b11111111111111111111111111111111)  # = 11111111 11111111 11111111 11111111

    def test_wenn_erstelle_bitmaske_netzwerkpart_freien_bits_fuer_hostpart_ist_eine_ungerade_zahl_gebe_subnetzmaske_zurueck(self):
        freie_bits_hostpart = 11
        self.assertEqual(main.erstelle_bitmaske_netzwerkpart(freie_bits_hostpart), 0b11111111111111111111100000000000)  # = 11111111 11111111 11111000 00000000
# ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
# ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    def test_wenn_ausgabe_netzwerk_broadcast_gebe_beides_aus(self, mock_stdout):
        netzwerkadressen_liste = [['255.0.0.0', '255.8.0.0', '255.16.0.0', '255.24.0.0'], ['255.7.255.255', '255.15.255.255', '255.23.255.255', '255.31.255.255']]
